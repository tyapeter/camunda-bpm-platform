...
public class DefaultMigrationPlanValidator implements MigrationPlanValidator {
  ...
  protected void ensureBoundaryEventsAreMigratedWithEventScope(MigrationInstruction instruction, List<MigrationInstruction> instructions, ProcessDefinitionImpl sourceProcessDefinition, ProcessDefinitionImpl targetProcessDefintion) {
    if (!MigrationInstructionValidators.SAME_EVENT_SCOPE.isInstructionValid(instruction, instructions, sourceProcessDefinition, targetProcessDefintion)) {
