...
public class NotMultiInstanceChildActivityValidator implements MigrationActivityValidator {

  public static NotMultiInstanceChildActivityValidator INSTANCE = new NotMultiInstanceChildActivityValidator();

  public boolean valid(ActivityImpl activity) {
    return activity != null && !hasMultiInstanceParent(activity);
  }
