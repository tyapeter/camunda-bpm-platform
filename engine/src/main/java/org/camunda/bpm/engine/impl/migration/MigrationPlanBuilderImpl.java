...
public class MigrationPlanBuilderImpl implements MigrationPlanBuilder {
  ...
  public MigrationPlanBuilder mapActivities(String sourceAcitivityId, String targetActivityId) {
    this.explicitMigrationInstructions.add(
        new MigrationInstructionImpl(Arrays.asList(sourceAcitivityId), Arrays.asList(targetActivityId)));
    return this;
  }
